...
def prepare_for_autoencoder(dataset, grid_size=(256, 80)):  # Changed from 88 to 80
    ...
    print(
        f"Grid coverage: {(1 - empty_points / total_points) * 100:.2f}% ({empty_points} empty points out of {total_points})"
    )
